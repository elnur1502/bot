                                                                                                                                            ...
                                                                                                                                            if float(float(price)*1.6) < float(float(priceU)-100):
                                                                                                                                                ...
                                                                                                                                                if float(float(price)*1.55) < float(float(priceU)-100):
                                                                                                                                                    ...
                                                                                                                                                    if float(float(price)*1.5) < float(float(priceU)-100):
                                                                                                                                                        ...
                                                                                                                                                        if float(float(price)+1000) < float(float(priceU)-200):
                                                                                                                                                            print(game + ' - ' + str(round(float(price)+1000)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                        else:
                                                                                                                                                            if float(float(price)+900) < float(float(priceU)-200):
                                                                                                                                                                print(game + ' - ' + str(round(float(price)+900)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                            else:
                                                                                                                                                                if float(float(price)+800) < float(float(priceU)-200):
                                                                                                                                                                    print(game + ' - ' + str(round(float(price)+800)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                else:
                                                                                                                                                                    if float(float(price)+700) < float(float(priceU)-200):
                                                                                                                                                                        print(game + ' - ' + str(round(float(price)+700)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                    else:
                                                                                                                                                                        if float(float(price)+650) < float(float(priceU)-200):
                                                                                                                                                                            print(game + ' - ' + str(round(float(price)+650)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                        else:
                                                                                                                                                                            if float(float(price)+600) < float(float(priceU)-200):
                                                                                                                                                                                print(game + ' - ' + str(round(float(price)+600)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                            else:
                                                                                                                                                                                if float(float(price)+550) < float(float(priceU)-200):
                                                                                                                                                                                    print(game + ' - ' + str(round(float(price)+550)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                else:
                                                                                                                                                                                    if float(float(price)+500) < float(float(priceU)-200):
                                                                                                                                                                                        print(game + ' - ' + str(round(float(price)+500)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                    else:
                                                                                                                                                                                        if float(float(price)+450) < float(float(priceU)-200):
                                                                                                                                                                                            print(game + ' - ' + str(round(float(price)+450)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                        else:
                                                                                                                                                                                            if float(float(price)+400) < float(float(priceU)-200):
                                                                                                                                                                                                print(game + ' - ' + str(round(float(price)+400)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                            else:
                                                                                                                                                                                                    if float(float(price)+1000) < float(float(priceU)-300):
                                                                                                                                                                                                        print(game + ' - ' + str(round(float(price)+1000)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                    else:
                                                                                                                                                                                                        if float(float(price)+900) < float(float(priceU)-300):
                                                                                                                                                                                                            print(game + ' - ' + str(round(float(price)+900)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                        else:
                                                                                                                                                                                                            if float(float(price)+800) < float(float(priceU)-300):
                                                                                                                                                                                                                print(game + ' - ' + str(round(float(price)+800)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                            else:
                                                                                                                                                                                                                if float(float(price)+700) < float(float(priceU)-300):
                                                                                                                                                                                                                    print(game + ' - ' + str(round(float(price)+700)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                else:
                                                                                                                                                                                                                    if float(float(price)+650) < float(float(priceU)-300):
                                                                                                                                                                                                                        print(game + ' - ' + str(round(float(price)+650)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                    else:
                                                                                                                                                                                                                        if float(float(price)+600) < float(float(priceU)-300):
                                                                                                                                                                                                                            print(game + ' - ' + str(round(float(price)+600)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                        else:
                                                                                                                                                                                                                            if float(float(price)+550) < float(float(priceU)-300):
                                                                                                                                                                                                                                print(game + ' - ' + str(round(float(price)+550)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                            else:
                                                                                                                                                                                                                                if float(float(price)+500) < float(float(priceU)-300):
                                                                                                                                                                                                                                    print(game + ' - ' + str(round(float(price)+500)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                else:
                                                                                                                                                                                                                                    if float(float(price)+450) < float(float(priceU)-300):
                                                                                                                                                                                                                                        print(game + ' - ' + str(round(float(price)+450)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                    else:
                                                                                                                                                                                                                                        if float(float(price)+400) < float(float(priceU)-300):
                                                                                                                                                                                                                                            print(game + ' - ' + str(round(float(price)+400)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                        else:
                                                                                                                                                                                                                                            if float(float(price)+1000) < float(float(priceU)-400):
                                                                                                                                                                                                                                                print(game + ' - ' + str(round(float(price)+1000)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                            else:
                                                                                                                                                                                                                                                if float(float(price)+900) < float(float(priceU)-400):
                                                                                                                                                                                                                                                    print(game + ' - ' + str(round(float(price)+900)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                                else:
                                                                                                                                                                                                                                                    if float(float(price)+800) < float(float(priceU)-400):
                                                                                                                                                                                                                                                        print(game + ' - ' + str(round(float(price)+800)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                                    else:
                                                                                                                                                                                                                                                        if float(float(price)+700) < float(float(priceU)-400):
                                                                                                                                                                                                                                                            print(game + ' - ' + str(round(float(price)+700)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                                        else:
                                                                                                                                                                                                                                                            if float(float(price)+650) < float(float(priceU)-400):
                                                                                                                                                                                                                                                                print(game + ' - ' + str(round(float(price)+650)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                                            else:
                                                                                                                                                                                                                                                                if float(float(price)+600) < float(float(priceU)-400):
                                                                                                                                                                                                                                                                    print(game + ' - ' + str(round(float(price)+600)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                                                else:
                                                                                                                                                                                                                                                                    if float(float(price)+550) < float(float(priceU)-400):
                                                                                                                                                                                                                                                                        print(game + ' - ' + str(round(float(price)+550)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                                                    else:
                                                                                                                                                                                                                                                                        if float(float(price)+500) < float(float(priceU)-400):
                                                                                                                                                                                                                                                                            print(game + ' - ' + str(round(float(price)+500)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                                                        else:
                                                                                                                                                                                                                                                                            if float(float(price)+450) < float(float(priceU)-400):
                                                                                                                                                                                                                                                                                print(game + ' - ' + str(round(float(price)+450)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                                                            else:
                                                                                                                                                                                                                                                                                if float(float(price)+400) < float(float(priceU)-400):
                                                                                                                                                                                                                                                                                    print(game + ' - ' + str(round(float(price)+400)) + ' рублей' + '.' + '(Скидка ' + sale+') ' + 'В магазине Майкрософт: ' + str(priceU) + ' рублей')
                                                                                                                                                                                                                                                                                else:
                                                                                                                                                                                                                                                                                     print('') 
